<x-app-layout>
    ...
    <div class="mb-6">
        <h2 class="text-xl font-semibold text-primary">Edit Administrator</h2>
    </div>
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('admin.administrators.update', $administrator) }}">
                ...
                <fieldset class="fieldset">
                    ...
                    <input id="name" type="text" name="name" value="{{ old('name', $administrator->name) }}"
                ...
                <fieldset class="fieldset mt-4">
                    ...
                    <input id="first_name" type="text" name="first_name" value="{{ old('first_name', $administrator->first_name) }}"
                ...
                <fieldset class="fieldset mt-4">
                    ...
                    <input id="email" type="email" name="email" value="{{ old('email', $administrator->email) }}"
                        class="input input-bordered w-full" required />
                    @error('email')
                        <p class="label text-error text-sm">{{ $message }}</p>
                    @enderror
                ...
                <fieldset class="fieldset mt-4">
                    ...
                    <p class="label text-base-content/70 text-sm">{{ __('Leave blank to keep the current password') }}</p>
                    @error('password')
                        <p class="label text-error text-sm">{{ $message }}</p>
                    @enderror
                </fieldset>
