<x-app-layout>
    ...
    <div class="mb-6">
        <h2 class="text-xl font-semibold text-primary">{{ __('Create New Account') }}</h2>
    </div>
            ...
            <form method="POST" action="{{ route('admin.users.store') }}">
                ...
                <section class="mb-6 border-b border-base-200 pb-6 grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div>
                        ...
                        <p>
                            {{ __('Please fill in the following information to create a new account.') }}
                        </p>
                    </div>
                ...
                <section class="mb-6 border-b border-base-200 pb-6 grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div>
                        ...
                        <p>
                            {{ __('Set account credentials and professional information.') }}
                        </p>
                    </div>
                ...
                <section class="mb-6 border-b border-base-200 pb-6 grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div>
                        ...
                        <p>
                            {{ __('Assign organization and role permissions to the account.') }}
                        </p>
                    </div>
                ...
                <section class="mb-6 grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div>
                        ...
                        <p>
                            {{ __('Define account status and notification settings.') }}
                        </p>
                    </div>
                    ...
                    <div class="col-span-2">
                        ...
                        <fieldset class="fieldset mb-4">
                            <label class="fieldset-legend cursor-pointer justify-start gap-2">
                                <input id="status" name="status" type="checkbox" value="1"
                                    {{ old('status') ? 'checked' : '' }} class="checkbox checkbox-sm checkbox-primary" />
                                <span>{{ __('Active') }}</span>
                            </label>
                        </fieldset>
                        ...
                        <fieldset class="fieldset mb-4">
                            <label class="fieldset-legend cursor-pointer justify-start gap-2">
                                <input id="send_activation_email" name="send_activation_email" type="checkbox" value="1"
                                    {{ old('send_activation_email', '1') ? 'checked' : '' }}
                                    class="checkbox checkbox-sm checkbox-primary" />
                                <span>{{ __('Send Activation Email') }}</span>
                            </label>
                        </fieldset>
                    </div>
                </section>
