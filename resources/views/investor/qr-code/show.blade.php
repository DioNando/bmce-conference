<x-app-layout>
    <div class="breadcrumbs text-sm mb-4">
        <ul>
            <li><a href="{{ route('investor.dashboard') }}" class="text-primary">{{ __('Investor Dashboard') }}</a></li>
    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div class="flex gap-3">
                <a href="{{ route('investor.qr-code.download') }}" class="btn btn-primary">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 gap-3">
                            ...
                            <div class="flex justify-between">
                                ...
                                <span class="badge badge-primary">{{ __('Investor') }}</span>
                            </div>
                            @if($user->phone)
                                <div class="flex justify-between">
            ...
            <div class="card-body">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div class="text-center">
                        ...
                        <p class="text-sm text-base-content/70">{{ __('Share your QR code with meeting organizers for quick identification') }}</p>
                    </div>
                    <div class="text-center">
                        <div class="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-3">
                            <svg class="w-6 h-6 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <p class="text-sm text-base-content/70">{{ __('Scanning your QR code provides instant access to your profile information') }}</p>
                    </div>
                </div>
            </div>
        </div>
